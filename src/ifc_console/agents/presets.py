...
them into a running agent through the same :func:`~ifc_console.agents.blocks.compose`
...
from ifc_console.agents.blocks import BLOCK_NAMES, compose, features_for
