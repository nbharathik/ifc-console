...
from ifc_console_agents.packs import AgentPackInfo, AgentPackRegistry
...
class TestPanelRuntime:
    ...
    async def test_pack_agent_answers_with_real_tools(self, core, work_model):
        ...
        from ifc_console_agents.panel import panel_runtime
        from ifc_console_agents.testing import tool_call_round
...
class TestBlueprints:
    def test_project_blueprint_is_atomic_and_appears_in_the_registry(self, tmp_path):
        from ifc_console_agents.blueprints import AgentBlueprint, AgentBlueprintStore
    ...
    def test_old_blueprint_defaults_to_the_previous_budget(self):
        from ifc_console_agents.blueprints import AgentBlueprint
    ...
    async def test_blueprint_builds_only_selected_block_tools(self, tmp_path):
        ...
        from ifc_console_agents.blueprints import AgentBlueprint, BlueprintPack
