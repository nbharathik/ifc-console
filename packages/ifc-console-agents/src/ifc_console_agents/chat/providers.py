...
def resolve_key(provider: Provider, supplied: str | None = None) -> str:
    ...
    from ifc_console_agents.credentials import get_api_key
...
def list_models(
    ...
    *,
    ...
    if provider.family == "rehearsal":
        from ifc_console_agents.devkit.rehearsal import REHEARSAL_MODELS
...
def stream(
    ...
    *,
    ...
    if provider.family == "rehearsal":
        from ifc_console_agents.devkit.rehearsal import rehearsal_stream
