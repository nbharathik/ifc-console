...
The agent itself is data now: see :mod:`ifc_console_agents.presets`. This
...
from ifc_console_agents.presets import MEASUREMENT, PresetPack
from ifc_console_agents.proposals import MeasurementMetric, build_proposal_source
