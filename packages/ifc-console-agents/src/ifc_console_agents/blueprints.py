...
and pick from :mod:`ifc_console_agents.blocks`, but cannot name arbitrary
operations or weaken the runtime's capability and approval policy. The same
:func:`~ifc_console_agents.blocks.compose` call builds them and the built-in
...
from ifc_console_agents.blocks import BLOCK_BY_NAME, BLOCKS, compose, features_for
