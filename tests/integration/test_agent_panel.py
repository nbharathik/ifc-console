...
class ApprovalPack(ScriptedPack):
    ...
    async def build(self, runtime, *, model, viewer: bool = False):
        from ifc_console import Agent
        from ifc_console.testing import ok_envelope
...
async def test_changed_blueprint_forks_after_the_in_memory_thread_is_gone(panel_core):
    from ifc_console.agents.blueprints import AgentBlueprint, AgentWorkflow
...
async def test_a_finished_run_only_denies_its_own_pending_approvals():
    ...
    from ifc_console.agents.panel import AgentPanelState, PanelApprovalHandler
...
async def test_an_approval_card_carries_the_change_it_would_make():
    ...
    from ifc_console.agents.models import AgentEvent, ApprovalRequest
    from ifc_console.agents.panel import _event_payloads
...
async def test_a_paged_tool_result_says_how_much_of_it_arrived():
    from ifc_console.agents.models import AgentEvent
    from ifc_console.agents.panel import _event_payloads
