...
from ifc_console.agents.models import ApprovalRequest
from ifc_console.integrations import langgraph as integration
...
def test_importing_adapter_does_not_import_langgraph() -> None:
    probe = (
        "import sys; import ifc_console.integrations.langgraph; "
...
def test_factory_has_a_clear_optional_dependency_error(monkeypatch) -> None:
    ...
    with pytest.raises(integration.LangGraphUnavailable, match=r"ifc-console\[graph\]"):
